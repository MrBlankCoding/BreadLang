...
int bread_llvm_link_executable_with_clang(const char* obj_path, const char* out_path) {
    ...
    snprintf(rt_path, sizeof(rt_path), "%s/breadlang/src/runtime/runtime.c", root_dir);
    snprintf(memory_path, sizeof(memory_path), "%s/breadlang/src/runtime/memory.c", root_dir);
    snprintf(print_path, sizeof(print_path), "%s/breadlang/src/runtime/print.c", root_dir);
    snprintf(string_ops_path, sizeof(string_ops_path), "%s/breadlang/src/runtime/string_ops.c", root_dir);
    snprintf(operators_path, sizeof(operators_path), "%s/breadlang/src/runtime/operators.c", root_dir);
    snprintf(array_utils_path, sizeof(array_utils_path), "%s/breadlang/src/runtime/array_utils.c", root_dir);
    snprintf(value_ops_path, sizeof(value_ops_path), "%s/breadlang/src/runtime/value_ops.c", root_dir);
    snprintf(builtins_path, sizeof(builtins_path), "%s/breadlang/src/runtime/builtins.c", root_dir);
    // Need to improve ERR
    snprintf(error_path, sizeof(error_path), "%s/breadlang/src/runtime/error.c", root_dir);
    
    snprintf(value_core_path, sizeof(value_core_path), "%s/breadlang/src/core/value_core.c", root_dir);
    snprintf(value_array_path, sizeof(value_array_path), "%s/breadlang/src/core/value_array.c", root_dir);
    snprintf(value_dict_path, sizeof(value_dict_path), "%s/breadlang/src/core/value_dict.c", root_dir);
    snprintf(value_optional_path, sizeof(value_optional_path), "%s/breadlang/src/core/value_optional.c", root_dir);
    snprintf(value_struct_path, sizeof(value_struct_path), "%s/breadlang/src/core/value_struct.c", root_dir);
    snprintf(value_class_path, sizeof(value_class_path), "%s/breadlang/src/core/value_class.c", root_dir);
    snprintf(var_path, sizeof(var_path), "%s/breadlang/src/core/var.c", root_dir);
    snprintf(function_path, sizeof(function_path), "%s/breadlang/src/core/function.c", root_dir);
    snprintf(type_descriptor_path, sizeof(type_descriptor_path), "%s/breadlang/src/core/type_descriptor.c", root_dir);
    
    snprintf(ast_path, sizeof(ast_path), "%s/breadlang/src/compiler/ast/ast.c", root_dir);
    snprintf(expr_path, sizeof(expr_path), "%s/breadlang/src/compiler/parser/expr.c", root_dir);
    snprintf(expr_ops_path, sizeof(expr_ops_path), "%s/breadlang/src/compiler/parser/expr_ops.c", root_dir);
    
    snprintf(ast_memory_path, sizeof(ast_memory_path), "%s/breadlang/src/compiler/ast/ast_memory.c", root_dir);
    snprintf(ast_types_path, sizeof(ast_types_path), "%s/breadlang/src/compiler/ast/ast_types.c", root_dir);
    snprintf(ast_expr_parser_path, sizeof(ast_expr_parser_path), "%s/breadlang/src/compiler/ast/ast_expr_parser.c", root_dir);
    snprintf(ast_stmt_parser_path, sizeof(ast_stmt_parser_path), "%s/breadlang/src/compiler/ast/ast_stmt_parser.c", root_dir);
    
    snprintf(ast_dump_path, sizeof(ast_dump_path), "%s/breadlang/src/compiler/ast/ast_dump.c", root_dir);
    snprintf(inc_path, sizeof(inc_path), "%s/breadlang/include", root_dir);
