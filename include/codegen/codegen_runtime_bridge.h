...
// Connect codegen class to runtime class
int cg_connect_class_to_runtime(Cg* cg, CgClass* cg_class, BreadClass* runtime_class);

// Connect all codegen classes to runtime
int cg_connect_all_classes_to_runtime(Cg* cg);

// Execute LLVM function with BreadValue arguments
...
// Create runtime method wrapper for LLVM function
